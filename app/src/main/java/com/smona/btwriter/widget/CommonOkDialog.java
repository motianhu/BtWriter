...
public class CommonOkDialog extends Dialog implements View.OnClickListener {
    ...
    public CommonOkDialog(Context context, String title, String content) {
        this(context, title, content, null);
    }

    public CommonOkDialog(Context context, String title, String content, OnCommitListener listener) {
    ...
    public CommonOkDialog setCommitListener(OnCommitListener listener) {
        this.listener = listener;
        return this;
    }
    ...
    public CommonOkDialog setContent(String content) {
        this.content = content;
        return this;
    }

    public CommonOkDialog setCancel(String cancel) {
        this.cancel = cancel;
        return this;
    }

    public CommonOkDialog setPositiveButton(String name) {
        this.positiveName = name;
        return this;
    }

    public CommonOkDialog setContainLink(boolean isLink){
        this.isContainLink = isLink;
        return this;
    }

    public CommonOkDialog setSpannable(SpannableString spannable) {
        this.spannableString = spannable;
        return this;
    }

    public CommonOkDialog setInterceptKey(int key){
