...
public class OrderModel {
    public void requestOrderList(ReqGoodsList reqGoodsBean, OnResultListener<BaseResponse<RespOrderList>> listener) {
        HttpCallbackProxy<BaseResponse<RespOrderList>> callbackProxy = new HttpCallbackProxy<BaseResponse<RespOrderList>>(listener){};
        new DynamicBuilder<RespOrderList>(DynamicBuilder.REQUEST_POST, BusinessHttpService.ORDER_LIST).requestData(reqGoodsBean, callbackProxy);
    }

    public void requestOrderDetail(ReqGoodsList reqGoodsBean, OnResultListener<BaseResponse<OrderDetailBean>> listener) {
